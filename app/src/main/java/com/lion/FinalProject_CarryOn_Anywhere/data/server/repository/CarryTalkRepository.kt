    ...
    companion object {
        ...
        suspend fun toggleLike(documentId: String, userId: String): Boolean {
            return try {
                ...
                val likeUserList = snapshot.get("talkLikeUserList") as? MutableList<String> ?: mutableListOf()
                var likeCount = snapshot.getLong("talkLikeCount")?.toInt() ?: 0
                ...
                val updateData = mapOf(
                    "talkLikeCount" to likeCount,
                    "talkLikeUserList" to likeUserList
                )
        ...
        suspend fun getLikeStatus(documentId: String, userId: String): Boolean {
            return try {
                ...
                val likeUserList = snapshot.get("talkLikeUserList") as? List<String> ?: emptyList()
