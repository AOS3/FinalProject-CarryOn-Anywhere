...
| **역할** | <ul><li>프로젝트 계획 및 관리</li><li>팀 리딩 및 커뮤니케이션</li><li>캐리온 여행 계획 기능 디자인</li><li>로그인 / 회원가입 기능 구현 (카카오, Firebase Auth)</li><li>메인 화면 구현</li><li>한국 관광공사 API를 활용한 장소 검색 및 찜 기능 구현</li></ul> | <ul><li>프로젝트 일정 조율 및 팀원 간 커뮤니케이션</li><li>코드 리뷰 진행</li><li>캐리온 메인 & 로그인 기능 디자인</li><li>여행 계획 작성 및 공유 기능 구현</li><li>Google Maps API를 사용한 지도 구현</li><li>다음 주소 검색 API를 활용한 주소 검색 기능 구현</li></ul> | <ul><li>사용자 마이페이지, 찜 화면, 나의 일정 화면 디자인</li><li>비밀번호 찾기 및 새 비밀번호 설정 기능 구현</li><li>나의 글(여행 이야기, 여행 후기, 나의 댓글) 기능 구현</li><li>캐리톡 댓글 기능(작성, 수정 및 삭제) 구현</li><li>서비스 이용 약관 및 개인정보 처리 방침 표시</li><li>계정 설정(회원 이미지 및 회원 정보 변경) 및 비밀번호 변경 기능 구현</li><li>내 일정 기능 구현</li><li>로그아웃 및 회원 탈퇴 기능 구현</li></ul> | <ul><li>캐리톡(여행 후기, 여행 이야기), 상세 보기, 수정 및 작성 화면 디자인</li><li>게시글 작성 및 수정 기능 구현</li><li>여행 후기 게시판 화면 및 상세 보기 기능 구현</li><li>여행 이야기 게시판 화면 및 상세 보기 기능 구현</li><li>앨범 권한을 사용하여 사진 게시 가능 기능 구현</li></ul> |
